...
"); // Set kolom A3 dengan tulisan "NO"
$excel->setActiveSheetIndex(0)->setCellValue('E6', "Untuk dimensi yang memiliki lebih dari satu pertanyaan, silahkan beri nilai tepat di bawah kolom penilaian sebelumnya
"); // Set kolom A3 dengan tulisan "NO"
